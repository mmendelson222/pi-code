...
# ----------------------------
BACKGROUND_BMP = "/bmps/weather_bg3.bmp"
...
def update_banner_todayforecast(banner, data):
    ...
    banner[1][0] = ICON_MAP.index(data["weather"][0]["icon"][:2])
    banner[2].text = temperature_text(data["main"]["temp"])
...
today_wind = label.Label(FONT, text="99m/s", color=0x000000)
...
if fetch_data:
    ...
    if EXTENDED_FORECAST:
        ...
        for forecast in list:
            ...
            print("dt: {} {}".format(dt.tm_mday, fmt_time(dt)))
